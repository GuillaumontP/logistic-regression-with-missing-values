...
print(c("matrice de confusion avec le modèle complet",confusionMatrix(table(predCCall,y.confusion)) ))
print(c("matrice de confusion sans se soucier des valeurs manquantes",confusionMatrix(table(predNAall,y.confusion)) ))
